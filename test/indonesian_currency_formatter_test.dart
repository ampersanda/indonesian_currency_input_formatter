...
void main() {
  test('parse', () {
    ...
    expect(IndonesianCurrencyInputFormatter.parse('123456789.12'), 12345678912.0);
    expect(IndonesianCurrencyInputFormatter.parse('123456789,12'), 123456789.12);
    expect(IndonesianCurrencyInputFormatter.parse('123.456.789,12'), 123456789.12);
